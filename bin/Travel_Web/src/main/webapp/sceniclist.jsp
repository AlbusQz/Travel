    ...
    <div class="degree">
        <div class="wrapper">
            ...
            <div class="top-search">
                <form  method="post" id="searchform" action="scenicsearch">
                    <div>
            ...
            <div id="nav-holder">
                <ul id="nav" class="sf-menu">
                    ...
                    <li class="current_page_item"><a href="sceniclist">HOTEL</a>
                    </li>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="title-holder"><br>
                <b style="font-size: x-large;">&nbsp;&nbsp;&nbsp;&nbsp;景点门票</b>
                <ul class="portfolio-pager">
                    <li><a href="subScenicPageServlet">NEWER</a></li><!--上一页按钮-->
                    <li class="last-child"><a href="addScenicPageServlet">OLDER</a></li><!--下一页按钮-->
                </ul>
            </div>
            <!-- ENDS title -->
...
<%	if(session.getAttribute("sceniclist")!=null)
			{
				List<entity.Scenic> sceniclist =(List<entity.Scenic>)session.getAttribute("sceniclist");
				//int start =(int) session.getAttribute("start"); 
				for(int i=0;i<sceniclist.size()&&i<5;i++)
				{
					Scenic temp=sceniclist.get(i);
					out.print("<ul class='staff'>  <a href='scenicshow?scenicshowid="+i+"' > <li> ");
					out.print("<img src='scenicpic"+i+"'/> ");
					out.print("<div class='information'>"+temp.getName());
					out.print(" <div class='header'>景点星级："+temp.getStars());
