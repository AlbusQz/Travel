    ...
    <div class="degree">
        <div class="wrapper">
            ...
            <div class="top-search">
                <form  method="post" id="searchform" action="linesearch">
                    <div>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="title-holder"><br>
                <b style="font-size: x-large;">&nbsp;&nbsp;&nbsp;&nbsp;旅游路线</b>
                <ul class="portfolio-pager">
                    <li><a href="subLinePageServlet">NEWER</a></li><!--上一页按钮-->
                    <li class="last-child"><a href="addLinePageServlet">OLDER</a></li><!--下一页按钮-->
                </ul>
            </div>
            <!-- ENDS title -->
...
<%	if(session.getAttribute("linelist")!=null)
			{
				List<entity.Line> linelist =(List<entity.Line>)session.getAttribute("linelist");
				//int start =(int) session.getAttribute("start"); 
				for(int i=0;i<linelist.size()&&i<5;i++)
				{
