            ...
            <div class="reg_form reg_form_step1">
                ...
                <dl>
                    ...
                    <dd>
                        ...
                        <input class="r_input input_country-code_num" type="text" placeholder="请输入有效手机号" id="mobilephone"/>
                        <br><input type="hidden" id="codeResult"><br>
                        <input type="hidden" id="nameResult"></dd>
                </dl>
                <br/><br/><br/>
                <div class="base_error" style="display: none" id="errphone"></div>
                ...
                <dl>
                    ...
                    <dd>
                        <div class="r_input input_auth-code"><input class="" type="text" placeholder="请输入验证码" id="valcode">
                            <a href="sendText" id="sendvalcode">发送验证码</a></div>
                    </dd>
                </dl>
                ...
                <dl>
                    <dt class="label">&nbsp;</dt>
                    <dd><input type="checkbox" name="running" ><label class="base_label">同意
                        <a id="agreementUrl" target="_blank">《服务协议》</a>和<a id="policyUrl" target="_blank">《隐私政策》</a></label>
                    </dd>
                </dl>
                <dl class="form_space">
                    <dt class="label">&nbsp;</dt>
                    <dd><input class="reg_btn" type="submit" value="下一步，设置密码" onclick="window.open('register.jsp')" id="regBtn"><br>
                      </dd>
                </dl>
            </div>
            </div>
