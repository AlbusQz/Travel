    ...
    <div class="degree">
        <div class="wrapper">
            ...
            <div class="top-search">
                <form  method="post" id="searchform" action="hotelsearch">
                    <div>
            ...
            <div id="nav-holder">
                <ul id="nav" class="sf-menu">
                    ...
                    <li class="current_page_item"><a href="hotellist">HOTEL</a>
                    </li>
                    <li><a href="spot.jsp">SCENIC SPOT</a></li>
                    <li ><a href="ticketlist">TICKET</a>
                    </li>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="title-holder"><br>
                <b style="font-size: x-large;">&nbsp;&nbsp;&nbsp;&nbsp;酒店预订</b>
                <ul class="portfolio-pager">
                    <li><a href="subHotelPageServlet">NEWER</a></li><!--上一页按钮-->
                    <li class="last-child"><a href="addHotelPageServlet">OLDER</a></li><!--下一页按钮-->
                </ul>
            </div>
            <!-- ENDS title -->
...
<%	if(session.getAttribute("hotellist")!=null)
			{
				List<entity.Hotel> hotellist =(List<entity.Hotel>)session.getAttribute("hotellist");
				//int start =(int) session.getAttribute("start"); 
				for(int i=0;i<hotellist.size()&&i<5;i++)
				{
					Hotel temp=hotellist.get(i);
					out.print("<ul class='staff'>  <a href='hotelshow?hotelshowid="+i+"' > <li> ");
					out.print("<img src='hotelpic"+i+"'/> ");
					out.print("<div class='information'>"+temp.getName());
					out.print(" <div class='header'>联系方式："+temp.getTel());
					out.print(" <div class='contact'>所在城市："+temp.getCity().getName());
					out.print("</div> <div style='font-size: xx-large; float:right'>￥"+temp.getRooms().get(0).getPrice()+"起");
