    ...
    <div class="degree">
        <div class="wrapper">
            ...
            <div class="top-search">
                <form  method="post" id="searchform" action="tipsearch">
                    <div>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="title-holder"><br>
                <b style="font-size: x-large;">&nbsp;&nbsp;&nbsp;&nbsp;旅游攻略</b>
                <ul class="portfolio-pager">
                    <li><a href="subTipPageServlet">NEWER</a></li><!--上一页按钮-->
                    <li class="last-child"><a href="addTipPageServlet">OLDER</a></li><!--下一页按钮-->
                </ul>
            </div>
            <!-- ENDS title -->
...
<%	if(session.getAttribute("tiplist")!=null)
			{
				List<entity.Tip> tiplist =(List<entity.Tip>)session.getAttribute("tiplist");
				//int start =(int) session.getAttribute("start"); 
				for(int i=0;i<tiplist.size()&&i<5;i++)
				{
					Tip temp=tiplist.get(i);
					out.print("<ul class='staff'>  <a href='tipshow?tipshowid="+i+"' > <li> ");
					out.print("<img src='tippic"+i+"'/> ");
					out.print("<div class='information'>"+temp.getId());
					out.print(" <div class='header'>作者姓名："+temp.getCustomer().getName());
					
					out.print(" <div class='contact'>创建时间："+temp.getCtime().toString());
