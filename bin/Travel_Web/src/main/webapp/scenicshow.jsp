        ...
        <div class="wrapper">
            ...
            <div id="nav-holder">
                <ul id="nav" class="sf-menu">
                    ...
                    <li class="current_page_item"><a href="scenic.jsp">HOTEL</a></li>
                    <li><a href="portfolio.html">SCENIC SPOT</a></li>
                    <li ><a href="sceniclist">TICKET</a></li>
    ...
    <div class="wrapper">
        ...
        <div class="content-blog" style="min-height: 200px">
            ...
            <div id="posts" >
                ...
                <div class="post"style="border-right: 3px solid #369;">
                    ...
                    <div class="post-header">
                        <div><b style="font-size: x-large;">景点门票</b></div>
					...
					{
						scenic =(Scenic)session.getAttribute("scenicshow");
					}
                    ...
                    <!-- post-content -->
                    <div>
                        <img src="scenicpic" alt="Dummy" title="dummy-about-2" />
                    </div>
            ...
            <ul2 >
                ...
                <%
                        	out.print("<br/><br/><p >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp景点名称:"+scenic.getName()+"</p>");
                        	out.print("<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp所在城市:"+scenic.getCity().getName()+"</p>");
                        	out.print("<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp价格:"+scenic.getPrice()+"</p>");
                        	out.print("<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp景点星极:"+scenic.getStars()+"</p>");
