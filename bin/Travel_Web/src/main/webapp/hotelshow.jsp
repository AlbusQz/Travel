        ...
        <div class="content-blog" style="min-height: 200px">
            ...
            <div id="posts" >
                ...
                <div class="post"style="border-right: 3px solid #369;">
                    ...
                    <%
                    Hotel hotel =null;
					if(session.getAttribute("hotelshow")!=null)
					{
						hotel =(Hotel)session.getAttribute("hotelshow");
					}
                    ...
                    <!-- post-content -->
                    <div>
                        <img src="hotelpic" alt="Dummy" title="dummy-about-2" />
                    </div>
            ...
            <ul2 >
                ...
                <%
                        	out.print("<br/><br/><p >&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp酒店名称:"+hotel.getName()+"</p>");
                        	out.print("<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp所在城市:"+hotel.getCity().getName()+"</p>");
                        	out.print("<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp价格:"+hotel.getRooms().get(0).getPrice()+"</p>");
                        	out.print("<p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp房间类型:"+hotel.getRooms().get(0).getType()+"</p>");
