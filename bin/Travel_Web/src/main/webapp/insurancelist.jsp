    ...
    <div class="degree">
        <div class="wrapper">
            ...
            <div class="top-search">
                <form  method="post" id="searchform" action="insurancesearch">
                    <div>
            ...
            <div id="nav-holder">
                <ul id="nav" class="sf-menu">
                    ...
                    <li class="current_page_item"><a href="insurance.jsp">TICKET</a>
                    </li>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="title-holder"><br>
                <b style="font-size: x-large;">&nbsp;&nbsp;&nbsp;&nbsp;购买保险</b>
                <ul class="portfolio-pager">
                    <li><a href="subInsurancePageServlet">NEWER</a></li><!--上一页按钮-->
                    <li class="last-child"><a href="addInsurancePageServlet">OLDER</a></li><!--下一页按钮-->
                </ul>
            </div>
            <!-- ENDS title -->
...
<%	if(session.getAttribute("insurancelist")!=null)
			{
				List<entity.Insurance> insurancelist =(List<entity.Insurance>)session.getAttribute("insurancelist");
				//int start =(int) session.getAttribute("start"); 
				for(int i=0;i<insurancelist.size()&&i<5;i++)
				{
					Insurance temp=insurancelist.get(i);
					out.print("<ul class='staff'>  <a href='insuranceshow?insuranceshowid="+i+"' > <li> ");
					out.print("<img src='insurancepic"+i+"'/> ");
					out.print("<div class='information'>"+temp.getName());
					out.print(" <div class='header'>保险公司："+temp.getAgency());
					out.print(" <div class='contact'>保险时间："+temp.getPeriod()+"天");
					//out.print(" <div class='contact'>出行方式："+temp.getType());
					out.print("</div> <div style='font-size: xx-large; float:right'>￥"+temp.getPricel());
