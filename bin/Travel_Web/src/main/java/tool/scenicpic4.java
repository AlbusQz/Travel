 ...
 */
@WebServlet("/scenicpic4")
public class scenicpic4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int pic=4;
		List<Scenic> out=null;
		if(session.getAttribute("sceniclist")!=null)
		{
			out=(List<Scenic>) session.getAttribute("sceniclist");
		}
		Scenic temp = out.get(pic);
