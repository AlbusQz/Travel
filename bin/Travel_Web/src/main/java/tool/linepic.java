...
/**
 * Servlet implementation class linepic
 */
@WebServlet("/linepic")
public class linepic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		{
		//	pic=(int) session.getAttribute("linepic");
		...
		{
			out=(Line) session.getAttribute("lineshow");
		}
		Line temp = out;
