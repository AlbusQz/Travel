...
/**
 * Servlet implementation class insurancepic
 */
@WebServlet("/insurancepic")
public class insurancepic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		{
		//	pic=(int) session.getAttribute("insurancepic");
		...
		{
			out=(Insurance) session.getAttribute("insuranceshow");
		}
		Insurance temp = out;
