...
/**
 * Servlet implementation class hotelpic
 */
@WebServlet("/hotelpic")
public class hotelpic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		{
		//	pic=(int) session.getAttribute("hotelpic");
		...
		{
			out=(Hotel) session.getAttribute("hotelshow");
		}
		Hotel temp = out;
