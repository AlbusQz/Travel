...
/**
 * Servlet implementation class tippic
 */
@WebServlet("/tippic")
public class tippic extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(session.getAttribute("tippic")!=null)
		{
		//	pic=(int) session.getAttribute("tippic");
		...
		{
			out=(Tip) session.getAttribute("tipshow");
		}
		Tip temp = out;
        ...
        pic++;
        session.setAttribute("tippic", pic);
